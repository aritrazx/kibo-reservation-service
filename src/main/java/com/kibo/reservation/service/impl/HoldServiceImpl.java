...
// Implementation removed: HoldService is implemented in com.kibo.reservation.service.HoldService
@Service
public class HoldServiceImpl implements HoldService {
    private final DropRepository dropRepository;
        ...
        public HoldServiceImpl(DropRepository dropRepository,
        ...
        public Hold find(String holdId) {
            return holdRepository.findByIdWithDrop(holdId)
                    .orElseThrow(() -> new NotFoundException("Hold not found: " + holdId));
        }

        public void addOutbox(String type, Hold hold) {
            try {
